...
const Home: PageWithLayout<void> = () => {
    return (
        <>
            <SEO
                title="Work smart"
                description="Work smart, save time & stress"
                image="https://cdn.bridge.africa/static-assets/hero/smart-hero.png"
            />
            <HeroSection
                text={{
                    pre: '',
                    emph: 'Work smart,',
                    end: 'save time & stress',
                    className: 'lg:max-w-[500px]',
                }}
                subText="Bridge allows you connect with people closest to you with the right skills to meet your demands."
                imageUrl={'https://cdn.bridge.africa/static-assets/hero/smart-hero.png'}
